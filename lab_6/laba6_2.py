...
check_lines = CheckButtons(ax_MNK, ["МНК", "np.polyfit", "Град. спуск"], [True, True, True])
...
def update(val):
    ...
    new_grad_k, new_grad_b, new_mse_history = gradient_descent(x, y, learning_rate, new_n_iter)
