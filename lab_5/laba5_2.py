...
line, = ax[0].plot(t, harmonic_with_noise(t, default_amplitude, default_frequency, default_phase, default_noise_mean, default_noise_covariance, default_show_noise), linewidth=2, color="green")
line2, = ax[1].plot(t, harmonic_with_noise_filtered(t, default_amplitude, default_frequency, default_phase), linewidth=2, color="red")
...
def update(val):
    ...
    line2.set_ydata(harmonic_with_noise_filtered(t, amplitude, frequency, phase))
